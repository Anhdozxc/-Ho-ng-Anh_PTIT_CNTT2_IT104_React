interface Category_bai6 {
  id: string;
  name: string;
}
interface Product_bai6 {
  id: string;
  name: string;
  price: number;
  category: Category_bai6;
  discount?: number;
}
// tính giá cuối cùng sau giảm giá
function getFinalPrice_bai6(product: Product_bai6): number {
  if (product.discount) {
...
function printProductInfo_bai6(product: Product_bai6): void {
...
const listProduct_bai6: Product_bai6[] = [
  {
    id: "P001",
    name: "Áo sơ mi",
    price: 300000,
